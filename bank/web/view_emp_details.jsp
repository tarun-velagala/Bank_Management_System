<%-- 
    Document   : view_emp_details
    Created on : May 25, 2018, 11:44:11 AM
    Author     : tarun
--%>
...
.link .back{
    ...
    <body>
        ...
        <div class="heading2"><h1>EMPLOYEE DETAILS</h1></div>
        <table id="details">
            ...
            <%
                ...
                ResultSet rs = st.executeQuery("select * from edets");
                while (rs.next()) {
